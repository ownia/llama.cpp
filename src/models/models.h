...
struct llama_model_qwen3tts : public llama_model_base {
    llama_model_qwen3tts(const struct llama_model_params & params) : llama_model_base(params) {}
    void load_arch_hparams(llama_model_loader & ml) override;
    void load_arch_tensors(llama_model_loader & ml) override;
...
struct llama_model_qwen3tts_cp : public llama_model_base {
    llama_model_qwen3tts_cp(const struct llama_model_params & params) : llama_model_base(params) {}
    void load_arch_hparams(llama_model_loader & ml) override;
    void load_arch_tensors(llama_model_loader & ml) override;
